declare module 'lodash' {
  ...
  declare class Lodash {
    ...
    contains(str: string, value: string, fromIndex?: number): bool;
    ...
    sortBy<V, T: Object>(object: T, iteratees?: Array<OIteratee<T>>): Array<V>;
    sortByAll<T>(array: ?Array<T>, iteratees?: Array<Iteratee<T>>): Array<T>;
    sortByAll<V, T: Object>(object: T, iteratees?: Array<OIteratee<T>>): Array<V>;
    sortByOrder<T>(array: ?Array<T>, iteratees?: Array<Iteratee<T>>|string, orders?: Array<'asc'|'desc'>|string): Array<T>;
    sortByOrder<V, T: Object>(object: T, iteratees?: Array<OIteratee<*>>|string, orders?: Array<'asc'|'desc'>|string): Array<V>;
    ...
    max<T>(array: ?Array<T>, iteratee?: Iteratee<T>): T;
    max<V, T>(object: ?T, iteratee?: OIterateeWithResult<V, T, number>): V;
    mean(array: Array<*>): number;
    meanBy<T>(array: Array<T>, iteratee?: Iteratee<T>): number;
    min<T>(array: ?Array<T>, iteratee?: Iteratee<T>): T;
    min<V, T>(object: ?T, iteratee?: OIterateeWithResult<V, T, number>): V;
    multiply(multiplier: number, multiplicand: number): number;
    round(number: number, precision?: number): number;
    subtract(minuend: number, subtrahend: number): number;
    sum(array: Array<*>): number;
    sum(array: Object): number;
    ...
    bindAll(object?: ?Object, ...methodNames: Array<string>): Object;
    callback<T>(func: ?Iteratee<T>, thisArg: any): Iteratee<T>;
